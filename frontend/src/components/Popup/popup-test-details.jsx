    ...
    <Popup trigger={testDetailsPopup} setTrigger={setTestDetailsPopup}>
        ...
        <div className={styles.formContainer}>   
            ...
            <div className={styles.formSection} style={{margin: "-20px 0 0 0"}}>
                <br />
                        <h3><i className="fa-solid fa-circle fa-2xs" style={{color: "#007bff", marginRight: "10px"}}></i> Test Details</h3>
                ...
                <div className={styles.formSection}>
                    <h3><i className="fa-solid fa-circle fa-2xs" style={{color: "#007bff", marginRight: "10px"}}></i> Test Result Entry</h3>
            ...
            <div className={styles.formSection}>
                <h3><i className="fa-solid fa-circle fa-2xs" style={{color: "#007bff", marginRight: "10px"}}></i> Verification</h3>
